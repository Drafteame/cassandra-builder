...
import (
	...
	query "github.com/Drafteame/cassandra-builder/qb/query"
)
...
func (_m *Client) Config() models.Config {
	ret := _m.Called()
...
func (_m *Client) PrintFn() query.DebugPrint {
	ret := _m.Called()

	var r0 query.DebugPrint
	if rf, ok := ret.Get(0).(func() query.DebugPrint); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(query.DebugPrint)
		}
	}
